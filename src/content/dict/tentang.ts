...
/**
 * Halaman TENTANG (korporat) & KONTAK & BLOG.
 * Aris: narasi perusahaan, misi, dan kontak ada di sini.
 */
...
export const tentang = {
  ...
  hero: {
    eyebrow: { id: "Tentang Kami", en: "About Us" } as Locale,
    title: {
      id: "Membebaskan Tanah Pertanian dari Toksisitas Kimia",
...
export const kontak = {
  ...
  hero: {
    eyebrow: { id: "Kontak", en: "Contact" } as Locale,
    title: { id: "Bicara Langsung dengan Kami", en: "Talk to Us Directly" } as Locale,
    lead: {
      id: "Satu kanal untuk semua kebutuhan — konsultasi dosis, pemesanan, hingga kerja sama OEM. Aris menjawab di jam kerja.",
      en: "One channel for everything — dosage consultation, ordering, and OEM partnerships. Aris answers during working hours.",
    } as Locale,
  },
  channels: {
    wa: { id: "WhatsApp (utama)", en: "WhatsApp (primary)" } as Locale,
  ...
  form: {
    title: { id: "Kirim pesan cepat", en: "Send a quick message" } as Locale,
    lead: {
      id: "Isi formulir singkat ini — pesan Anda akan terbuka di WhatsApp dalam format siap kirim.",
      en: "Fill in this short form — your message will open in WhatsApp, ready to send.",
    } as Locale,
    name: { id: "Nama", en: "Name" } as Locale,
    namePh: { id: "Nama Anda", en: "Your name" } as Locale,
    wa: { id: "Nomor WhatsApp", en: "WhatsApp number" } as Locale,
    waPh: { id: "cth. 0812xxxxxxx", en: "e.g. 0812xxxxxxx" } as Locale,
    location: { id: "Lokasi", en: "Location" } as Locale,
    locationPh: { id: "cth. Karawang, Jawa Barat", en: "e.g. Karawang, West Java" } as Locale,
    sector: { id: "Sektor", en: "Sector" } as Locale,
    sectors: [
    ...
    messagePh: {
      id: "Ceritakan kebutuhan Anda — kondisi lahan, jenis ternak, atau pertanyaan produk…",
      en: "Tell us what you need — field conditions, livestock type, or product questions…",
    } as Locale,
    submit: { id: "Kirim via WhatsApp", en: "Send via WhatsApp" } as Locale,
    validation: {
      name: { id: "Nama wajib diisi.", en: "Name is required." } as Locale,
      wa: { id: "Nomor WhatsApp wajib diisi.", en: "WhatsApp number is required." } as Locale,
      message: { id: "Pesan wajib diisi.", en: "Message is required." } as Locale,
    },
    preview: { id: "Pesan yang akan terkirim:", en: "Message that will be sent:" } as Locale,
  },
} as const;
